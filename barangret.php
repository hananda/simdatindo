...
<html>
    ...
    <h1 align="center"><b>Isi Form Dibawah Ini Untuk Input Barang Yang Direturn</b></h1>
...
<div id="result" style="display:none;"></div>
	<form id="form1" name="form1" method="post" action="regbrgret.php" >
  ...
  <tr>
    ...
    <td  width="512"><label for="noform"></label>
      <input name="noform" type="text" id="noform" value="R-" maxlength="7"></td>
  </tr>
  <tr>
