...
<br>
<p align="center"><strong>Silahkan isi form dibawah ini untuk menambah Cabang</strong></p>
...
<div id="result" style="display:none;"></div>
	<form id="formreg" action="prosescabang.php?task=tambah" method="post">
    <div align="center">
    <table width="400" border="6">
  <tr>
    <td width="123"><strong>Nama Cabang :</strong></td>
        <td  class="field" width="255" bgcolor="#FFFFFF">
      <input type="text" name="nmcabang" id="nmcabang"></td>
  </tr>
  <tr>
