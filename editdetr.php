...
<html>
    ...
    <h1 align="center"><b>Isi Form Dibawah Ini Untuk Edit Barang Yang Direturn</b></h1>
...
<?php
			...
			$noform= $_GET['no_form_r'] ;
  			$query = "SELECT * FROM tbl_det_return WHERE no_form_r='$noform'";
	...
	<form id="form1" name="form1" method="post" action="updatebrgr.php" >
  ...
  <tr>
    ...
    <td  width="512"><label for="noform"></label>
      <input name="noform" type="text" id="noform" value="<?php echo $r['no_form_r'];?>" readonly></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="34"><strong>Alasan Return</strong></td>
    <td class="field"><div align="center"><span class="field">
      <input name="alasan" type="text" id="alasan" value="<?php echo $r['alasan'];?>">
    </span></div></td>
  </tr>
  <tr>
    
    <td height="34"><strong>Tgl Return</strong></td>
    <td><input type="text" id="tgl_return" name="tgl_return" onClick="if(self.gfPop)gfPop.fPopCalendar(document.form1.tgl_return);return false;" value="<?php echo $r['tgl_return'];?>"/><a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.form1.tgl_return);return false;"><img name="popcal" align="absmiddle" style="border:none" src="calender/calender.jpeg" width="34" height="29" border="0" alt=""></a></td>
  </tr>
