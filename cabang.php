...
<p align="center"><strong>Master Data Cabang</strong></p>
  ...
  <tr>
    ...
    <td><div align="center"><strong>Nama Cabang</strong></div></td>
    <td colspan="2"><div align="center"><strong>Aksi</strong></div></td>
  </tr>
    <?php
  $sql =  custom_query("SELECT * FROM tbl_cabang");
  ...
  <tr>
    ...
    <td width="50"><div align="center"><a href="editcabang.php?id=<?php echo $r['id_cabang']; ?>">Edit</a></div></td>
    <td width="50"><div align="center"><a href="prosescabang.php?task=hapus&idcabang=<?php echo $r['id_cabang']; ?>" title="Hapus" onClick="return konfirmasihapus()">Hapus</a></div></td>
  </tr>
