...
<p align="center"><strong>Silahkan edit form dibawah ini untuk mengedit keterangan</strong></p>
<?php
$id = $_GET['id'] ;
  $sql =  custom_query("SELECT * FROM tbl_keterangan WHERE id_keterangan='$id'");
  while ($r = mysqli_fetch_array($sql))
  { 
  ?> 
	<form action="prosesketerangan.php?task=edit" method="post" id="update">
    <div align="center">
    <table width="400" border="6">
    <input type="hidden" name="idketerangan" value="<?php echo $id; ?>" />
  <tr>
    <td width="123"><strong>Nama keterangan :</strong></td>
    <td  class="field" width="255" bgcolor="#FFFFFF"><label for="username"></label>
      <input name="nmketerangan" type="text" id="nmketerangan" value="<?php echo $r['nama_keterangan']; ?>" /></td>
  </tr>
  <tr>
